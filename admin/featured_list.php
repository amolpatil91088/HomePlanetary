...
<div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Featured Property List</li>
          </ol>
        </section>
                                         ...
                                         <div class="row">
                                            <div class="col-xs-12">
                                              <div class="box">
                                                <div class="box-body">
                                                 <?php
                                                  $qr="SELECT * FROM add_posting where add_status='Featured'";
                                                 ...
                                                 <table id="example2" class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FFFFFF">
                                                         ...
                                                         <td><input type='button' id=<?php echo $row['property_id'];?> value='Unfeatured' onclick='approve_func(this.id)'></td>
                                                    </tr>
                                                     <?php endwhile; ?>
                                                    </tbody>
                                                  </table>
...
<script language="javascript" type="text/javascript">
    function approve_func(myid)
    {
        ...
        ajaxRequest.open("GET", "unfeatured.php" + queryString, true);
